    ...
    <div className="pt-20 flex flex-col">
      ...
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">Find your Dream Car with Axora AI</h1>
            ...
            {carMakes.map((make)=>{
              return(
                <Link
                  ...
                  className="bg-white rounded-l-lg shadow p-4 text-center hover:shadow-md transition cursor-pointer"
                >
            ...
            {bodyTypes.map((type)=>{
              return(
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent rounded-b-lg flex items-end">
